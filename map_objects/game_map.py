...
class GameMap:
    ...
    def create_h_tunnel(self, x1, x2, y): 
        ...
        for x in range(min(x1, x2), max(x1, x2) + 1):
            self.tiles[x][y].blocked = False
            self.tiles[x][y].block_sight = False
            self.tiles[x][y+lr].blocked = False
            self.tiles[x][y+lr].block_sight = False
    ...
    def make_map(self, max_rooms, room_min_size, room_max_size, map_width, map_height, player, entities):
        ...
        down_stairs = Entity(center_of_last_room_x, center_of_last_room_y, '>', libtcod.white, 0,  'Stairs',
    ...
    def next_floor(self, player, message_log, constants):
        ...
        message_log.add_message(Message('Respira, recupera e vai.', libtcod.light_violet))
